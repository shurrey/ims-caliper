...
var SelectTextResponse = require('../../lib/entities/response/selectTextResponse');
var clientUtils = require('../../lib/clients/clientUtils');
var testUtils = require('../testUtils');

const path = config.testFixturesBaseDir + "caliperEntitySelectTextResponse.json";

testUtils.readFile(path, function(err, fixture) {
  if (err) throw err;

  test('selectTextResponseTest', function (t) {
    ...
    var entity = entityFactory().create(SelectTextResponse, {
