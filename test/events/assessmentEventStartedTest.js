...
const path = config.testFixturesBaseDir + "caliperEventAssessmentStarted.json";

testUtils.readFile(path, function(err, fixture) {
  if (err) throw err;

  test('assessmentEventStartedTest', function (t) {
    ...
    uuid = "urn:uuid:27734504-068d-4596-861c-2315be33a2a2";
